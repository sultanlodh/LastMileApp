config = {
    ...
    "producer_settings": {
        "bootstrap.servers": '10.10.25.26:9092'  # Same as consumer settings
    },

    #,'tracking_db.tracking_live.PAYMENT_DETAILS','tracking_db.tracking_live.CONSIGNMENT_HISTORY'

    "topics": ['tracking_live.tracking_live.ADDRESS_DETAILS','tracking_live.tracking_live.BOOKING_DETAILS','tracking_live.tracking_live.CONSIGNMENT','tracking_live.tracking_live.CONSIGNMENT_HISTORY','tracking_live.tracking_live.PAYMENT_DETAILS','tracking_live.tracking_live.REFERENCE_LINK'],
    ...
    "Refrence_Link_Final_Schema": ['foc_cnno', 'foc_podimage'],

    "Adress_Details_Final_Schema": ['foc_cnno','foc_receiver_name','foc_receiver_phno', 'foc_receiver_address', 'foc_receiver_city', 'foc_receiver_state', 'foc_receiver_pincode', 'foc_sender_name', 'foc_sender_phno', 'foc_sender_address', 'foc_sender_city', 'foc_sender_state', 'foc_sender_pincode', 'foc_receiver_company_name', 'foc_sender_company_name'],

    "Payment_Details_Final_Schema": ['foc_cnno', 'foc_ndx_amtcollected'],
